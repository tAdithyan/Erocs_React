...
import ArrowIcon from '../assets/arrow-right-storke.png';
...
const Header = () => {
    ...
    const containerVariants = {
      ...
      // Menu items animation variants with stagger
  ...
  >
    <div className="relative w-10 h-10">
      ...
      {/* Hero Section */}
      <div className="px-4 sm:px-10  md:px-20 lg:px-32 xl:px-40 2xl:px-56  ">
        <div className="max-w-5xl  sm:mt-24 md:mt-36 lg:mt-40    ">
   
        <h1 className="text-[4rem] sm:text-5xl md:text-6xl xl:text-8xl font-bold mt-32  sm-space-y-5 md:space-y-12 lg:space-y-12 ">
  <motion.div
  ...
  <TypingAnimation />
        ...
        <h1 className="absolute xl:bottom-16 text-2xl   sm:text-3xl" data-aos="fade-right"
     data-aos-offset="300"
     data-aos-easing="ease-in-sine">1k + Brands Trust Us</h1>
